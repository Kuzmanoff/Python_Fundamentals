...
price_milk_100 = price_flour * 1.25

total_price = price_flour + (price_eggs * eggs) + (price_milk_100 * milk_025)
...
print(f"You made {bread_counter} loaves of Easter bread! Now you have {colored_eggs} eggs and {budget_left:.2f}BGN left.")