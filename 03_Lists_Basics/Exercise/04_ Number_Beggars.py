...
list_a = input().split(', ')
temp_list = []
beggar_nums = int(input())
 
 
 
if beggar_nums == len(list_a):
    list_a = [int(x) for x in list_a]
    print(list_a)
 
 
elif len(list_a) < beggar_nums:
    for x in range(beggar_nums - len(list_a)):
        list_a.append(0)
    list_a = [int(x) for x in list_a]
    print(list_a)
    ...
    list_a = [int(x) for x in list_a]
    for x in range(beggar_nums):
        temp_list.append(sum(list_a[x::beggar_nums%len(list_a)]))
    print(temp_list)